...
namespace App\Models {
     ...
     * @property string|null $updated_at
     * @property string|null $created_at
     * @property mixed $id_permiso
     * @property mixed $id_usuario
     * @property int $id_usuario_permiso
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso whereIdUsuarioPermiso($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso whereIdUsuario($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso whereIdPermiso($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UsuarioPermiso>|UsuarioPermiso query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class UsuarioPermiso extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
